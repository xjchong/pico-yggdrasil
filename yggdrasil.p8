...
function mob_los_p(m)
 ...
 return distance(mpos,ppos)<=m.vis and los(mpos,ppos)
end
-->8
--ai
...
function update_ai()
 ...
 for m in all(mobs) do
  local mpos,ppos=
   mob_pos(m),mob_pos(pc)
  local p_dmap_copy=get_dist_map(ppos)
...
function ai_idle_normal(m)
 ...
 for dnbor in all(ai_dnbors()) do
  local tpos=pos+dnbor --'to' pos
  local tx,ty=pos_to_xy(tpos)
  if not blocked(pos,tpos,"idle") then
   move_mob_pos(m,tpos)
   return
  end
 end
 ...
 move_mob_pos(m,pos+ai_dnbors()[1])
end
...
item_names={"rice","bell","phase"}
item_sprs={237,236,238}
item_tips={"recovers ♥","makes noise","teleports you"}
  ...
  for i=1,#inv+1 do
   if i==#inv+1 then
    ...
    if inv_item.name==item.name then
     local excess=(inv_item.qty+item.qty)-9
     if excess<=0 then
      inv_item.qty+=item.qty
      del(items,item)
      sfx(12)
     else
      if excess<item.qty then
       inv_item.qty=9
       item.qty=excess
       sfx(12)
      else
...
function loot_box_s(x,y)
 add_item(rnd{1,2,3},2,x,y)
end

function loot_box_l(x,y)
 add_item(rnd{1,2,3},3,x,y)
end

function loot_mob(m)
 if not get_item(m.x,m.y) and rnd()<0.08 then
  add_item(rnd{1,2,3},1,m.x,m.y)
 end
end
-->8
--button tools
...
__gfx__

...

...

...

...

...
1111111133313331666166611111111111111111111111111111111111111111616161611a111a111a111a1191999191a11111a11a1111a1aa1aa1a111111331
...
11111111313331316166616111111111111111111111111111111111111111111711171119119a1199119aa191999191aaa1aaa11aaaaaa1aa11119131331331
...

...

...

__map__
...
000500003c7603c7303c7203c7103c7103c7103c7103c7103c7003c7003c7003c7003c7003c7003c7003c7003c7003c7003c7003c700000003c70000000000000000000000000000000000000000000000000000
...
000900000c1201012013130181301a140181401c1501f150241500010000100001002615000100281502814028130281202811028110001000010000100001000010000100001000010000100001000010000100
